...
(
  'merry-berry-love', '/images/works/merry-berry-love.jpg', '메리 베리 러브', 2026, '로맨스',
...
(
  'joseon-attorney', '/images/works/joseon-attorney.jpg', '조선변호사', 2023, '사극 법정극',
  '(편집 포인트 작성 예정 — 알려주시면 반영할게요)',
  '드라마',
...
(
  'last-woman-on-earth', '/images/works/last-woman-on-earth.jpg', '지구 최후의 여자', 2026, '드라마, 코미디',
  '(편집 포인트 작성 예정 — 알려주시면 반영할게요)',
  '영화',
